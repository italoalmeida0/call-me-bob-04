...
const LS_SOLVED_KEY = "bob04_solved_chores";
const LS_CODE_PREFIX = "bob04_chore_code_";
const REPO_URL = "https://github.com/italoalmeida0/call-me-bob-04";
const PREV_SITE = {
      ...
      <div class="max-w-4xl mx-auto px-5 py-8 md:py-12">
        ...
        <div class="text-center mb-10">
          ...
          <p class="text-[#a8a29e] text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            Bob has a to-do list. You have Python. Help Bob fix his windmill,
            run the bake sale, tidy the workshop and watch his sunflowers — one
            chore at a time, right in your browser.
          </p>
          <a
            href={REPO_URL}
            target="_blank"
