...
# ---------------------------------------------------------------------
# Banned-call detection (used by Morning Milk Run and friends).
# Layer 1 — AST: any *use* of a banned name/attribute (even aliasing
# like f = sorted), plus string constants handed to getattr/eval/exec.
# Layer 2 — runtime: the banned builtins are replaced by tripwires
# BEFORE the player's code runs, so dynamic tricks like
...
def _bob_find_banned(user_src, banned_names, banned_attrs):
    try:
            ...
            if fname in ("eval", "exec", "compile"):
                for a in node.args:
                    if isinstance(a, _bob_ast.Constant) and isinstance(a.value, str):
                        ...
                        for w in words:
                            if w in banned_names or w in banned_attrs:
                                return w + "()"
    return None
...
var _tmpl$34 = /* @__PURE__ */ template(`<div class="h-full flex flex-col overflow-hidden"><div class=status-bar><span></span><span class=text-[#57534e]></span><span class=flex-1></span><span class=text-[#44403c]>call-me-bob 04`);
var LS_SOLVED_KEY = "bob04_solved_chores";
var LS_CODE_PREFIX = "bob04_chore_code_";
var PREV_SITE = {
  label: "call-me-bob 03",
  url: "https://italoalmeida0.github.io/call-me-bob-03/"
};
var NEXT_SITE = {
  label: "call-me-bob 05",
  url: "https://italoalmeida0.github.io/call-me-bob-05/"
};
