...
#   vars(x)['sort'] or __builtins__['sorted'] are caught even though
#   the string is "just data". If this causes a false positive (e.g. a
#   dict key that happens to match), the error message tells the user
#   to rename it.
...
#   importable modules (heapq.merge) are patched too. Originals are
#   restored after grading.
# ---------------------------------------------------------------------
